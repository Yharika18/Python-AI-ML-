...
SELECT title, rental_rate, rental_rate ^ 2 AS double_rate   -- debug why its allwoing string + integer
FROM sakila.film;
------------------------
---------------
#math 
...
FROM sakila.film;
----------
SELECT rental_rate, ROUND(replacement_cost / rental_rate, 0),ROUND(replacement_cost / rental_rate, 2) AS ratio
FROM sakila.film;
...
select last_update,dayofweek(last_update),monthname(last_update) from sakila.film;
